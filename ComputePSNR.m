...
load('E:\MATProjects\finalShit\mvqp37_I11_shit.mat');
%I =  Make4DLF('E:\MATProjects\finalShit\Results_convrgb444');
I = squeeze(LF_temp(:,:,1:434,1:625,1:3));
%R =  Make4DLF('E:\MATProjects\ShitShit\Results_saving\I01Bikes');
%R = squeeze(uint8LF(2:14,2:14,1:432,1:624,1:3));
load('E:\MATProjects\finalShit\Reference\I11Color_Chart_1_R.mat');
R = squeeze(light_field(2:14,2:14,:,:,1:3));
m = size(I,1);
n = size(I,2);
for k = 1:m
    for l = 1:n
...
save('mvqp37_I11_PSNRs.mat','PSNR_Y', 'PSNR_U', 'PSNR_V', 'PSNR_YUV', 'PSNR_Y_mean', 'PSNR_U_mean', 'PSNR_V_mean','PSNR_YUV_mean')
